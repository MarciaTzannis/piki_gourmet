...
$use_smtp = '0';
$emailto = 'pikigourmet@gmail.com';

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'Email from Piki';
	$message = '';
	$response = '';
	$response_fail = 'Houve um erro ao confirmar seus dados.';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Obrigado. Sua mensagem foi recebida.';
